...
AOS.init({duration:2000})
  ...
  return (
   <Box pt='80px' backgroundColor={mode?"black":'#ffffff'}  id='skills'>
     ...
     <Box data-aos="fade-up" display={{base:'grid',sm:'grid',md:'grid',lg:'flex'}}  justifyContent='center' alignItems='center'   gridTemplateColumns={{base:'repeat(2,1fr)',sm:"repeat(2,1fr)"}} gap='30px'  width={{base:'70%',sm:"70%",md:'70%',lg:'80%'}} margin='auto'   justifyContent='center'>
     {skills.map((el)=>(
